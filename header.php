...
<html lang="en">
	<head>
		...
		<link href="<?php bloginfo('stylesheet_directory'); ?>/css/jquery.fancybox.css" rel="stylesheet" type="text/css" media="screen" />
		<link href="<?php bloginfo('stylesheet_directory'); ?>/css/responsive.css" rel="stylesheet" type="text/css" media="screen" />
				...
				<div class="header__logo">
					...
					<?php if( is_front_page()) { ?>
						<a href="<?php bloginfo('url'); ?>">
							<h1 class="logo">
								<img src="<?php bloginfo('template_directory'); ?>/images/lightstore-logo-w.png" alt="Lighstore.">
							</h1>
						</a>
					<?php } else { ?>
						<a href="<?php bloginfo('url'); ?>">
